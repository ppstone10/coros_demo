...
### `HLTH-VIS-009`：卡片采用 Figma 2031 固定几何与安全区

- Given：页面按 375pt 设计宽度或任意等比手机宽度渲染
- When：三端展示 14 类健康卡片
- Then：卡片左右页边距为 16、圆角为 8，按类型使用 114/122/178/180/188/206 高度；标题基线、主值区与右侧概览区映射 Figma 节点 `16:8097`、`16:8866`、`16:8837`、`16:8810`、`16:8771`、`16:8742`、`16:8712`、`16:8651`、`16:8627`、`16:8482`、`16:8408`、`16:8389`、`16:8354`、`16:8192`
