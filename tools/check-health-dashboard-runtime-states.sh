...
facade="common/src/commonMain/kotlin/com/example/demo/common/health/facade/HealthFacade.kt"
ios_adapter="iosApp/iosApp/Core/Bridge/SharedLoginAdapter+Health.swift"
...
ios_pan="iosApp/iosApp/Health/Components/ScrollViewPanObserver.swift"
ios_hero="iosApp/iosApp/Health/Components/HeroTopRow.swift"
harmony_bridge="harmony-kmp-bridge/src/ohosArm64Main/kotlin/com/example/demo/harmony/bridge/HarmonyHealthBridge.kt"
...
check_present "$android" "healthViewModel.refresh()"
check_present "$facade" "fun healthError(): HealthError? = store.state.error"
check_present "$ios_adapter" "func healthState() -> HealthState?"
...
check_present "$ios_pan" "contentOffset.y <= -scrollView.adjustedContentInset.top + 1"
check_present "$ios_pan" "gestureBeganAtTop"
